package com.robick.sem8.project.config;
...
import com.robick.sem8.project.scheduler.EventMonitor;
...
public class SchedulerConfig {
	@Bean
	   ...
	   public SchedulerFactoryBean schedulerFactoryBean(JobFactory jobFactory,
	      ...
	      Trigger rt=simpleJobTrigger;
	      factory.setTriggers(rt);
	   ...
	   public SimpleTriggerFactoryBean simpleJobTrigger(
	         ...
	         @Value("${eventJob.frequency}") long frequency) {
	   ...
	   public JobDetailFactoryBean simpleJobDetail() {
	      ...
	      factoryBean.setJobClass(EventMonitor.class);
